...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="min-h-screen bg-gradient-civic-light flex items-center justify-center p-6">
        <div className="max-w-md w-full rounded-2xl border border-slate-200 bg-white p-8 text-center shadow-civic-lg">
          ...
          <p className="mt-3 text-sm text-slate-600">
            CivicGuide hit an unexpected error. You can retry the current page or return to the home dashboard.
          </p>
